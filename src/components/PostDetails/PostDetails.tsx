...
export const PostDetails: React.FC = () => {
  ...
  const shouldShowNoComments = comments.length === 0 && !isLoadingComments && !isErrorForm;
  const shouldShowComments = comments.length > 0 && !isLoadingComments && !isErrorForm && selectedPost;
